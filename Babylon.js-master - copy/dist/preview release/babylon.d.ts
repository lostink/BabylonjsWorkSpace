...
declare module BABYLON {
    class SpotLight extends ShadowLight {
        ...
        */
        ...
        exponent: number;
        private _textureProjectionMatrix;
        /**
...
declare module BABYLON {
    ...
    class ParticleSystem implements IDisposable, IAnimatable, IParticleSystem {
        ...
        private _epsilon;
        sphereEmitRadius: number;
        coneEmitRadius: number;
        coneEmitAngle: number;
        private _emissionShapeType;
        emissionShapeType: number;
        /**
        * An event triggered when the system is disposed.
        * @type {BABYLON.Observable}
        */
        ...
        constructor(name: string, capacity: number, scene: Scene, customEffect?: Nullable<Effect>, _isAnimationSheetEnabled?: boolean, epsilon?: number, emissionType?: number);
        private _createIndexBuffer();
